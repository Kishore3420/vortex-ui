        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {stats.map((stat, i) => (
            <ScaleIn key={stat.label} delay={i * 0.15}>
              <div className="text-center p-6 sm:p-8 rounded-xl bg-card border border-border hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10">
                <div className="text-5xl sm:text-6xl font-bold mb-2 bg-linear-to-r from-primary to-[#3282B8] bg-clip-text text-transparent">
                  {stat.number}
                </div>
